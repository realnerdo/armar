...
<body class="nav-md">
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="index.html" class="site_title"><span>Grupo Armar</span></a>
                    </div>
                    <!-- end navbar -->
                    ...
                    <div class="profile">
                        <div class="profile_pic">
                            <img src="{{ asset('img/logo.jpg') }}" alt="Grupo Armar" class="img-circle profile_img">
                        </div>
                        <div class="profile_info">
                            <span>Bienvenido,</span>
                            <h2>Adrián Rosales</h2>
                        </div>
                    </div>
                    <!-- /menu profile quick info -->

                    <br> @include('layout.sidebar')
    ...
    <script type="text/javascript" src="{{ asset('js/gentelella.min.js') }}"></script>
